...
export function ContactPage() {
  ...
  const socialLinks = [
    {
      platform: "LinkedIn",
      url: "https://www.linkedin.com/company/asme-mec-chapter/",
      username: "@ASMEMEC",
      icon: (
    ...
    {
      platform: "Instagram",
      url: "https://www.instagram.com/asme_mec",
      username: "@asme_mec",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  const helpfulLinks = [
    ...
    },
    {
      ...
      url: "https://signin.asme.org/s/login/?ec=302&startURL=%2Fs%2F",
...
<Card>
  ...
  <CardContent className="space-y-4">
    ...
    {/* The embedded map section is now functional */}
    <div className="bg-gray-100 rounded-lg p-4 h-48 flex items-center justify-center overflow-hidden">
      <iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d245.64591895222964!2d76.32860620781005!3d10.028865417953398!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b080c5006491601%3A0xcf23e14245d4694d!2sGovt%20Model%20Engineering%20College!5e0!3m2!1sen!2sin!4v1757923526071!5m2!1sen!2sin"
        width="100%"
        height="100%"
    ...
    {/* The "Open in Google Maps" button is now a working link */}
    <Button asChild variant="outline" className="w-full">
      <a 
        href="https://www.google.com/maps/place/Govt.+Model+Engineering+College,+Thrikkakara/@10.0381657,76.3262968,17z/data=!3m1!4b1!4m6!3m5!1s0x3b080c105553069b:0x356e7039a73d317e!8m2!3d10.0381657!4d76.3288717!16s%2Fg%2F122_z3r8" 
        target="_blank" 
